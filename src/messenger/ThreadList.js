...
class ThreadList extends React.Component {
    ...
    render() {
        ...
        for(let i = 0; i < this.state.threads.length; i++) {
            ...
            const threadUI = <Thread threadID={thread.id} title={thread.name} lastMsg={thread.lastMessage} lastActive={time.millisToTime(thread.lastActiveAt)} loadThreadIntoMessageViewer={this.props.loadThreadIntoMessageViewer}/>
